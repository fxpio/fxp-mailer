...
/**
 * Tests for Array template layout loader.
 *
 * @author François Pluchino <francois.pluchino@gmail.com>
 *
 * @internal
 */
final class ArrayTemplateLayoutLoaderTest extends TestCase
{
    public function testLoad(): void
    {
        ...
        $loader = new ArrayTemplateLayoutLoader([$template]);
    ...
    public function testLoadUnknownTemplate(): void
    {
        ...
        $loader = new ArrayTemplateLayoutLoader([]);
