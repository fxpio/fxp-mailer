...
/**
 * Tests for yaml template layout loader.
 *
 * @author François Pluchino <francois.pluchino@gmail.com>
 *
 * @internal
 */
final class YamlTemplateLayoutLoaderTest extends TestCase
{
    public function testLoad(): void
    {
        ...
        $loader = new YamlTemplateLayoutLoader([$template], $kernel);
    ...
    public function testLoadUnknownTemplate(): void
    {
        ...
        $loader = new YamlTemplateLayoutLoader([], $kernel);
